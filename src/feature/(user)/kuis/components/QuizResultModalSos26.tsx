  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onClose} modal={true}>
      <Dialog.Portal>
        ...
        <Dialog.Overlay className="fixed inset-0 z-50 bg-black/70 backdrop-blur-md transition-all duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
          <Dialog.Content
            ...
            style={{
              ...
              boxShadow: "inset 0 2px 4px 0 rgba(255,255,255,0.15), 0 16px 40px 0 rgba(0,0,0,0.6)",
          ...
          >
            ...
            {/* SUB-FRAME 1: Judul "Kuis Selesai !" & Garis Pembatas */}
            ...
            {/* SUB-FRAME 2: Nilai Kamu & Data Nilai */}
            <div className="w-full flex flex-col items-center">
            ...
            {/* SUB-FRAME 3: Tombol Kembali dengan Ikon Arrow Left */}
            <div className="w-full flex justify-center pt-2">
              <AktivitasButton
                onClick={onClose}
                className="w-[218px] py-3 rounded-xl flex items-center justify-center gap-2 text-white bg-[#8881BC] hover:bg-[#776fa8] shadow-lg cursor-pointer transition-all"
              >
