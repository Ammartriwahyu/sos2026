    ...
    <section className="pt-navbar relative z-10 w-full pb-8 md:pb-16 overflow-hidden">
      ...
      <div className="mycontainer mx-auto w-full max-w-6xl relative z-10 text-center text-white flex flex-col justify-center items-center gap-8 min-h-[50vh]">
        <motion.h2
          ...
          className="w-11/12 md:w-3/4 text-2xl sm:text-3xl font-bold text-center leading-tight md:leading-snug md:text-4xl lg:text-5xl text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300 drop-shadow-lg"
        >
        ...
        <motion.p
          ...
          className="text-sm md:text-base text-justify md:text-center w-11/12 md:w-4/5 lg:w-2/3 text-white/90 leading-relaxed drop-shadow-md"
        >
        ...
        {showToggle && (
          <motion.div
            ...
            className="flex flex-row justify-center gap-2 sm:gap-4 mt-6 w-full px-2 sm:px-0"
          >
            <a
              href="/stf"
